...
@NamedQueries({
    ...
    @NamedQuery(name = "DlTDetmh.analisisByTp", query = "SELECT dtd.valor FROM DlTDetmh dtd, ScAnalisis an WHERE dtd.analisisId.analisisId = an.analisisId AND an.tpanalisisId= :tpanalisis AND dtd.documento= :doc")    
})
